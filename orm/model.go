...
func (o *QuickOrm) Load(models interface{}, loads ...string) (int64, error) {
	db := o.DB
...
func (o *QuickOrm) CreateModel(model interface{}, omitColumns ...string) (interface{}, error) {
...
func (o *QuickOrm) CreateModels(models interface{}, omitColumns ...string) (interface{}, error) {
...
func (o *QuickOrm) UpdateModel(model interface{}, updateKvs interface{}) (int64, error) {
...
func (o *QuickOrm) UpdateModels(model interface{}, kv Where, updateKvs interface{}) (int64, error) {
	var result *gorm.DB
	db := o.DB.Model(model)
	db = o.BuildWhere(db, kv)
	if _, ok := updateKvs.(KVs); ok { // 将KVs类型强制转换为map[string]interface{}
		result = db.Updates(map[string]interface{}(updateKvs.(KVs)))
	} else {
